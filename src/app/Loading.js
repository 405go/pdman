...
export default class Loading extends React.Component{
  constructor(props) {
    ...
    this.state = {
      ...
      histories: [],
      columnOrder: [
        {code: 'chnname', value: '名称', com: 'Input', relationNoShow: false},
        {code: 'name', value: '代码', com: 'Input', relationNoShow: false},
        {code: 'type', value: '类型', com: 'Select', relationNoShow: false},
        {code: 'dataType', value: '数据库类型', com: 'Text', relationNoShow: true},
        {code: 'remark', value: '备注', com: 'Input', relationNoShow: true},
